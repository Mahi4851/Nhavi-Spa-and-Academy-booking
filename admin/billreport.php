...
<h1>Billing  Report</h1>
	...
	<table width="" border="1" class="rpt" > 
		<tr>
			<th>Bill ID</th>
			<th>Bill Date</th>
			<th>Customer ID</th>
			<th>Customer Name</th>
			<th>1.Service Name</th>
			<th>1.Service Rate</th>
			<th>2.Service Name</th>
			<th>2.Service Rate</th>
			<th>3.Service Name</th>
			<th>3.Service Rate</th>
			<th>4.Service Name</th>
			<th>4.Service Rate</th>
			<th>GST</th>
		...
		while($res=mysqli_fetch_array($result))
		{
			...
			echo "<td>".$res['rate']."</td>";
			echo "<td>".$res['sname2']."</td>";
			echo "<td>".$res['rate2']."</td>";
			echo "<td>".$res['sname3']."</td>";
			echo "<td>".$res['rate3']."</td>";
			echo "<td>".$res['sname4']."</td>";
			echo "<td>".$res['rate4']."</td>";
			echo "<td>".$res['gst']."</td>";
			echo "<td>".$res['damt']."</td>";
			echo "<td>".$res['namt']."</td>";
			echo "<td><a href=\"billedit.php?bid=$res[bid]\">Edit</a> | <a href=\"billdelete.php?bid=$res[bid]\" on
