...
<style type="text/css">
	body{background-image: url("image/img4.jpg");background-repeat: no-repeat;background-size: cover;}
...
$qry2=mysqli_query($conn,"SELECT * FROM service");
$qry3=mysqli_query($conn,"SELECT * FROM service");
$qry4=mysqli_query($conn,"SELECT * FROM service");
...
<form action="billing1.php" method="post">
	<table align="center" >
		...
		<tr>
			<th> <input type="text" name="bid" value="<?php echo $id; ?>" placeholder="Enter Bill ID" required readonly>	</th>
  ...
  ?>
			...
			<th><input type="text" name="cname" id="cname" placeholder="Enter Customer Name" required readonly style="margin-left: 90px;"></th>
		</tr>


		
		<tr>
			<th><label>1.Service Name:</label></th>
			<th><label>1.Service Rate:</label></th>
		</tr>
		<tr>
			<th><select name="sname" id="sname">
  <?php
  ...
  ?>
			...
			<th><input type="text" name="rate" id="rate" placeholder="Enter Rate "   style="margin-left: 90px;"></th>
		</tr>
...
<tr>
			<th><label>2.Service Name:</label></th>
			<th><label>2.Service Rate:</label></th>
		</tr>
<tr>
			<th><select name="sname2" id="sname1">
  <?php
  ...
  ?>
			...
			<th><input type="text" name="rate2" id="rate1" placeholder="Enter Rate " required  style="margin-left: 90px;"></th>
		</tr>
...
<tr>
			<th><label>3.Service Name:</label></th>
			<th><label>3.Service Rate:</label></th>
		</tr>
<tr>
			<th><select name="sname3" id="sname2">
  <?php
  ...
  ?>
			...
			<th><input type="text" name="rate3" id="rate2" placeholder="Enter Rate " required  style="margin-left: 90px;"></th>
		</tr>
...
<tr>
			<th><label>4.Service Name:</label></th>
			<th><label>4.Service Rate:</label></th>
		</tr>
<tr>
			<th><select name="sname4" id="sname3">
  <?php
  while($row2=mysqli_fetch_array($qry4))
  {
    echo"<option>".$row2[1]."</option>";
  }
  ?>
</select></th>
			<th><input type="text" name="rate4" id="rate3" placeholder="Enter Rate " required  style="margin-left: 90px;"></th>
		</tr>

<tr>
			<th><label>GST Amount:</label></th>
			<th><label>Discount Rate:</label></th>
		</tr>

		<tr>
			<th ><input type="text" name="gst" id="gst" placeholder="Enter GST Amount" required style="margin-left:;" ></th>
...
<script type="text/javascript">
  ...
  function sum() 
  {
   var rt = ( Number($("#rate").val()) + Number($("#rate1").val()) + Number($("#rate2").val()) + Number($("#rate3").val()) );
   var a = ( rt * Number($("#gst").val()) / 100);
...
<script type="text/javascript">
  $(document).ready(function (e){
    ...
    $('#sname2').change(function(){
      $.post("f1.php",{
        parent_id4: $('#sname2').val(),
      }, function(response){
        $('#rate2').val(response);
    ...
    $('#sname3').change(function(){
      $.post("f1.php",{
        parent_id5: $('#sname3').val(),
      }, function(response){
        $('#rate3').val(response);
